...
add_tooltip = function(bar) {
  ...
  return tooltip = d3.select('body').append('div').attr('class', 'tooltip').style('opacity', 1).style('left', "" + (rect.x.baseVal.value + offest + rect.width.baseVal.value / 2 - 47) + "px").style('top', "" + (rect.y.baseVal.value + 350) + "px").text("" + (Math.round(bar.datum())) + " GW-hrs");
};
